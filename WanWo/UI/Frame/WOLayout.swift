...
public final class WOLayoutStore: ObservableObject {
    ...
    // 批10：fullscreen 布局投影退役（2026-09-22 真机反馈"点开的右栏像全屏
    // 还关不掉"——投影与 WorkspaceRightSidebarModel.isFullscreen 双记账在
    // blank 会话期间脱钩：折算被 hasDetailsSession 门挡住→标题生成后突然
    // 复活挤压主区；真值归一后由 WOAppFrame 直读入参 fullscreen）
