//
//  BrowserManagementView.swift
//  WanWo
//
//  【vendored 复用 · 源=OpenMinis src/ios/Agent/BrowserUse/BrowserManagementView.swift，全文语义 1:1（B2 批）】
...
struct BrowserManagementView: View {
    ...
    var body: some View {
        ...
        .confirmationDialog("Clear All Cookies?", isPresented: $showClearConfirm, titleVisibility: .visible) {
            ...
            Text("This will remove all cookies and website data from the WanWo browser.")
        }
        .task {
            await loadCookies()
        }
    ...
    private var cookiesSection: some View {
        Section {
            ...
            Text("Clearing cookies will sign you out of all websites in the WanWo browser.")
        }
    }
